...
* So, based on <a href="http://dx.doi.org/10.1016/j.ijforecast.2015.11.013">GEFCOM 2014</a> and <a href="http://dx.doi.org/10.1016/j.ijforecast.2019.02.006">2017</a> winning entries, and my previous experience at Redback Technologies <a href="https://arxiv.org/abs/1810.11178">(Bean and Khan 2018)</a> I used <a href="https://www.jmlr.org/papers/v7/meinshausen06a.html">quantile regression forests of Meinshausen (2006).</a> I used the <a href="https://cran.r-project.org/web/packages/ranger/index.html">"ranger" R package</a> implementation as it's multithreaded. The median forecast with quantile 0.5 gets a significantly lower MASE than the mean forecast (because we are trying to minimize the sum of the deviations from the true forecast).
...
* trained all solar and building data together after seeing the <a href="https://doi.org/10.1016/j.ijforecast.2019.02.002">Smyl and Hua paper</a> and recalling the competition abstract *"the opportunity for cross-learning across time series on two different prediction problems (energy demand and solar production)."* (MASE 0.5220, 30 October)
